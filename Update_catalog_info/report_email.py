...
def main():
    ...
    email = emails.generate("automation@example.com", "student-00-d50b7297b142@example.com", "Upload Completed - Online Fruit Store", 
"All fruits are uploaded to our website successfully.A detailed list is as attached.",attachment)
    emails.send(email)
