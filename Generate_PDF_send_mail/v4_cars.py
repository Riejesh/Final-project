...
def process_data(data):
  ...
  for item in data:
    ...
    max_yearly_sale[item_year] += per_item_sales
      #popr_year.update({item_year : max_yearly_sale["yearly_sales"]})

    #print (popular_year)
  #popular_year.update({item_year : max_yearly_sale["yearly_sales"]})
    print (max_yearly_sale)

#  Max_val = max(popular_year , key = popular_year.get)
#  print (Max_val)
  ...
  summary = [
    ...
    #"The most popular year was {} with {} sales ".format(popular_year),
  ]
  return summary
...
def main(argv):
  ...
  data = load_data("2007_car_sales.json")
